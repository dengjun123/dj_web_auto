...
#测试数据源
testdates = [
    {"user":"dengjun","psw":"oPe8*aVPWTySmSzo","expect":True},
    {"user":"dengjun","psw":"","expect":False},
    {"user":"dengjun111","psw":"oPe8*aVPWTySmSzo","expect":False},
]
...
class LoginPageCase(unittest.TestCase):
    ...
    def login_case(self,user,psw,expect):
        ...
        user = "邓君"
        ressult = self.loginp.get_login_result(user)
        print(ressult)
